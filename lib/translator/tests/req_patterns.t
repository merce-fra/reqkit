List of supported structured English requirements and their translations:
  ...
  x0001 = Bool('x0001')
  x0000 = Bool('x0000')
  REQ_SET=[[ x0000 , x0000 , x0000 , 0, 0, 0, 0, x0001 , x0001 , x0001 , 2, 2 ]]
  COND_INIT = []
  $ cat patterns/3.req
  Input x0001 is bool
  Input x0000 is bool
  ...
  x0001 = Bool('x0001')
  x0000 = Bool('x0000')
  REQ_SET=[[ x0000 , x0000 , x0000 , 0, 0, 0, 0, True, x0001 , x0001 , 2, 2 ]]
  COND_INIT = []
  $ cat patterns/4.req
  Input x0001 is bool
  Input x0000 is bool
  ...
  x0001 = Bool('x0001')
  x0000 = Bool('x0000')
  REQ_SET=[[ x0000 , x0000 , x0000 , 0, 0, 0, 0, True, x0001 , Not(x0001 ), 0, 1 ]]
  COND_INIT = []
  $ cat patterns/5.req
  Input x0001 is bool
  Input x0000 is bool
  ...
  x0001 = Bool('x0001')
  x0000 = Bool('x0000')
  REQ_SET=[[ x0000 , x0000 , x0000 , 0, 0, 0, 0, True, Not(x0001 ), x0001 , 0, 2 ]]
  COND_INIT = []
  $ cat patterns/6.req
  Input x0001 is bool
  Input x0000 is bool
  ...
  x0001 = Bool('x0001')
  x0000 = Bool('x0000')
  REQ_SET=[[ x0000 , x0000 , x0000 , 2, 2, 0, 0, True, True, x0001 , 1, -1 ]]
  COND_INIT = []
  $ cat patterns/7.req
  Input x0001 is bool
  Input x0000 is bool
  ...
  x0001 = Bool('x0001')
  x0000 = Bool('x0000')
  REQ_SET=[[ x0000 , x0000 , x0000 , 2, 2, 0, 0, x0001 , x0001 , x0001 , 1, 1 ]]
  COND_INIT = []
  $ cat patterns/8.req
  Input x0001 is bool
  Input x0000 is bool
  ...
  x0001 = Bool('x0001')
  x0000 = Bool('x0000')
  REQ_SET=[[ x0000 , x0000 , x0000 , 2, 2, 0, 0, True, x0001 , x0001 , 1, 1 ]]
  COND_INIT = []
  $ cat patterns/9.req
  Input x0001 is bool
  Input x0000 is bool
  ...
  x0001 = Bool('x0001')
  x0000 = Bool('x0000')
  REQ_SET=[[ x0000 , x0000 , x0000 , 2, 2, 0, 0, True, True, Not(x0001 ), 0, 1 ]]
  COND_INIT = []
